describe('performance and functionality testing for mobile forheader-three-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for header-three-story',()=> {
     //  cy.viewport(360 ,640);
     ...
     it('Performance testing in mobile for header-three-story',()=> {
       cy.viewport(360 ,640);
      // cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=headers--header-three-story&viewMode=story');
        cy.lighthouse({
