describe('performance and functinality testing of auther-details-one-story in mobile',{taskTimeout: 90000},() => {
    it('functinality testing of auther-details-one-story in mobile',()=> {
        cy.viewport(360, 640);
    ...
    it('performance testing of auther-details-one-story component in mobile',() => {
        cy.viewport(360, 640);
    cy.visit('http://localhost:6006/iframe.html?args=&id=author-details--author-details-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
