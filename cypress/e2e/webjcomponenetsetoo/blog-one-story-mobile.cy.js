describe('functinality and performance testing of component blog-one-story in mobile',{taskTimeout:90000},() => {
    it('functinality of component blog-one-story in mobile ',() => {
        cy.viewport(360, 640);
