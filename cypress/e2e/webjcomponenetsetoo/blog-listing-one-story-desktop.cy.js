describe('functinality and performance testing of component blog-listing-one-story in desktop',{taskTimeout:90000},() => {
    it('functinality of component blog-listing-one-story in desktop ',() => {
...
//  cy.get(':nth-child(4) > .sm\:flex-row > .overflow-hidden > .object-cover').should('be.visible');
    ...
    it('Performance of component blog-listing-one-story in desktop ',() => {
        cy.viewport(1440, 1080);
        cy.visit('http://localhost:6006/iframe.html?args=&id=blog-listing--blog-listing-one-story&viewMode=story');
    cy.lighthouse({
        performance:20,
