describe('performance and functionality testing for dessktop for dashboard-steps-one-story1 component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in deskptop for dashboard-steps-one-story1',()=> {
     ...
     it('Performance testing in desktop for dashboard-steps-one-story1',()=> {
       //cy.viewport(360 ,640);
      // cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=dashboard-steps--dashboard-steps-one-story&viewMode=story');
        cy.lighthouse({
