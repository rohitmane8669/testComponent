describe('performance and functionality testing for mobile for program-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for program-one-story',()=> {
       cy.viewport(360 ,640);
