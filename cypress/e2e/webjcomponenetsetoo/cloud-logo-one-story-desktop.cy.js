describe('performance and functionality testing for desktop for cloud-logo-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for cloud-logo-one-story',()=> {
    //   cy.viewport(1440 ,1080);
     ...
     it('Performance testing in desktop for cloud-logo-one-story',()=> {
      // cy.viewport(1440 ,1080);
