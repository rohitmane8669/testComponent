describe('functinality and performance testing of author-one-story component in mobile',{taskTimeout: 90000},()=> {
    it('functinality testing of author-one-story component in mobile ',() => {
      cy.viewport(360, 640);
    ...
    it('performance testing of author-one-story component in mobile',()=>{
      cy.viewport(360, 640);
        cy.visit('http://localhost:6006/iframe.html?id=author--author-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
