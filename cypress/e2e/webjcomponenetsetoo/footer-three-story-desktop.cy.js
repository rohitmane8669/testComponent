describe('performance and functionality testing for desktop for footer-three-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for footer-three-story',()=> {
     ...
     it('Performance testing in desktop for footer-three-story',()=> {
       //cy.viewport(360 ,640);
      //cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=footer--footer-three-story&viewMode=story');
        cy.lighthouse({
