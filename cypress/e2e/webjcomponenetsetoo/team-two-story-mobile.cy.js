describe('performance and functionality testing for mobile for team-two-story component',{taskTimeout : 90000},() =>
    {
    ...
    it('Performance testing in mobile for team-two-story mobile component', () =>{
        cy.visit('http://localhost:6006/iframe.html?args=&id=team--team-two-story&viewMode=story');
        cy.lighthouse({
            performance:20,
            accessibility: 40,
