describe('performance and functionality testing for desktop for sign-up-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for sign-up-one-story',()=> {
     ...
     it('Performance testing in desktop for sign-up-one-story',()=> {
       //cy.viewport(360 ,640);
      //cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=signup--sign-up-one-story&viewMode=story');
        cy.lighthouse({
