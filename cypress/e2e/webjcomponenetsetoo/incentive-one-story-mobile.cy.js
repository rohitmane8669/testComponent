describe('performance and functionality testing for mobile for incentive-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for incentive-one-story',()=> {
       cy.viewport(360 ,640);
