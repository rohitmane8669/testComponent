describe('performance and functionality testing for desktop for dashboard-steps-two-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for cta-two-story',()=> {
     ...
     it('Performance testing in desktop for cta-two-story',()=> {
       //cy.viewport(360 ,640);
      //cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=cta--cta-two-story&viewMode=story');
        cy.lighthouse({
