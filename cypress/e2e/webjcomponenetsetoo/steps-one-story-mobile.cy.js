describe('performance and functionality testing for mobile for steps-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for steps-one-story',()=> {
       cy.viewport(360 ,640);
