describe('performance and functionality testing for desktop for pricing-two-story component',{taskTimeout: 100000},() =>
    {
    it('functinality testing in desktop for pricing-two-story',()=> {
     ...
     it('Performance testing in desktop for pricing-two-story',()=> {
       //cy.viewport(360 ,640);
//cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=pricing--pricing-two-story&viewMode=story');
        cy.lighthouse({
