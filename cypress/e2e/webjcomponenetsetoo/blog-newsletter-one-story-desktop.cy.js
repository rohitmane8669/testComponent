describe('functinality and performance testing of component blog-newsletter-one-story in desktop',{taskTimeout:90000},() => {
    it('functinality of component blog-newsletter-one-story in desktop ',() => {
    ...
    it('performance  of component blog-newsletter-one-story in desktop ',() => {
        cy.viewport(1440, 1080);
        cy.visit('http://localhost:6006/iframe.html?args=&id=blognewsletter--blog-newsletter-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
