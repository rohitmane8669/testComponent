describe('performance and functionality testing for desktop for testimonial-one-story-mobile component',{taskTimeout : 90000},() =>
{
// it('functinality testing of estimonial-one-story-mobile component in mobile', () =>
// {
//     cy.viewport(360 ,640);
...
// })
it('Performance testing in mobile for testimonial-one-story-mobile component', () =>{
    cy.visit('http://localhost:6006/iframe.html?args=&id=testimonials--testimonial-one-story&viewMode=story');
    cy.lighthouse({
        performance:20,
        accessibility: 40,
