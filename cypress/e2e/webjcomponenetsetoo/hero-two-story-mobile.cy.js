describe('performance and functionality testing for mobile for hero-two-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for hero-two-story',()=> {
        cy.viewport(360 ,640);
