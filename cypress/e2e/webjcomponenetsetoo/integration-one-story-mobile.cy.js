describe('performance and functionality testing for mobile for integration-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for integration-one-story',()=> {
       cy.viewport(360 ,640);
