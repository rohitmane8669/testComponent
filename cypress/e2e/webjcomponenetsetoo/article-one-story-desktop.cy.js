describe('functinality and performace testing of component  article-one-story in desktop',{taskTimeout: 90000}, () => {
    ...
    it('performance testing of article-one-story component in desktop',() => {
        cy.viewport(1440, 1080);
        cy.visit('http://localhost:6006/iframe.html?args=&id=article--article-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
