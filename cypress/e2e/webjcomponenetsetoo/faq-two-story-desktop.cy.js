describe('performance and functionality testing for desktop for faq-two-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for faq-two-story',()=> {
     ...
     it('Performance testing in desktop for faq-two-story',()=> {
       //cy.viewport(360 ,640);
      // cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=faq--faq-two-story&viewMode=story');
        cy.lighthouse({
