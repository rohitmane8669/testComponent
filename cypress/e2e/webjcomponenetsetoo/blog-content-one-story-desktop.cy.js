describe('functinality and  performance of blog-content-one-story component in desktop',{taskTimeout: 90000},()=> {
...
it('performance of of blog-content-one-story component in desktop ',()=> {
    cy.viewport(1440, 1080);
    cy.visit('http://localhost:6006/iframe.html?args=&id=blogcontent--blog-content-one-story&viewMode=story');
    cy.lighthouse({
        performance:20,
