describe('functinality and performance testing for approve-transaction-one-story component in mobile',{taskTimeout: 90000},() => {
    it('functinality testing for approve-transaction-one-story component in mobile' ,()=> {
        cy.viewport(360 ,640);
    ...
    it('performance tsting forapprove-transaction-one-story component in mobile',()=> {
        cy.viewport(360 ,640);
        cy.visit('http://localhost:6006/iframe.html?args=&id=approve-transaction--approve-transaction-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
