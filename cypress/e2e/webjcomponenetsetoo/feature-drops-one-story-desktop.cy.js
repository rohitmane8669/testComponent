describe('performance and functionality testing for desktop for feature-drops-one-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in desktop for feature-drops-one-story',()=> {
     ...
     it('Performance testing in desktop for  feature-drops-one-story component',()=> {
      // cy.viewport(360 ,640);
      // cy.viewport(1920 ,1060);
        cy.visit('http://localhost:6006/iframe.html?args=&id=featuredrops--feature-drops-one-story&viewMode=story');
        cy.lighthouse({
