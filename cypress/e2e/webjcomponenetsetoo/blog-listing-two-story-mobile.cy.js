describe('functinality and performance testing of component blog-listing-two-story in mobile',{taskTimeout:90000},() => {
    it('functinality of component blog-listing-two-story in mobile ',() => {
        cy.viewport(360, 640);
