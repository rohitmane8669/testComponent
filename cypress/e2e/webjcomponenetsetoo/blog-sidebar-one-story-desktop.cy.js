describe('functinality and performance testing of blog-sidebar-one-story component in desktop',{taskTimeout :  90000},() => {
    it('functinality testing of blog-sidebar-one-story component in desktop',() => {
    ...
    it('performance testing of blog-sidebar-one-story component in desktop' ,()=>{
        cy.viewport(1440 , 1080);
        cy.visit('http://localhost:6006/iframe.html?args=&id=blog-sidebar--blog-sidebar-one-story&viewMode=story');
        cy.lighthouse({
            performance:20,
