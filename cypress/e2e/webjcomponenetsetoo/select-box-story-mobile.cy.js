describe('performance and functionality testing for mobile for select-box-story component',{taskTimeout: 90000},() =>
    {
    it('functinality testing in mobile for select-box-story',()=> {
       cy.viewport(360 ,640);
     ...
     it('Performance testing in mobile for select-box-story',()=> {
       cy.viewport(360 ,640);
