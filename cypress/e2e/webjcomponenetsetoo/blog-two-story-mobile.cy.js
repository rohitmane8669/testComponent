describe('functinality and performance testing of blog-two-story component in mobile',{taskTimeout :  90000},() => {
    it('functinality testing of blog-two-story component in mobile',() => {
        cy.viewport(360, 640);
    ...
    it('performance testing of blog-two-story component in mobile' ,()=>{
        cy.viewport(360, 640);
        cy.visit('http://localhost:6006/iframe.html?args=&id=blog--blog-two-story&viewMode=story');
        cy.lighthouse({
            performance:20,
